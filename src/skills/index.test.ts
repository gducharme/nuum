...
describe("skills", () => {
  ...
  function createSkill(baseDir: string, dotDir: string, name: string, description: string): void {
...
`
  ...
  describe("formatSkillsCatalog", () => {
    ...
    it("formats single skill correctly", () => {
      ...
      expect(result).toContain("- deploy: Deploy to production (file: /home/user/project/.nuum/skills/deploy/SKILL.md)")
      expect(result).toContain("### Using Skills")
    })

    it("formats multiple skills correctly", () => {
      const skills = [
        { name: "deploy", description: "Deploy to production", path: "/path/deploy/SKILL.md" },
        { name: "testing", description: "Run tests", path: "/path/testing/SKILL.md" },
      ]
    ...
    it("includes usage instructions", () => {
      const skills = [{ name: "deploy", description: "Deploy", path: "/path/SKILL.md" }]
